...
var mySelf = { 
   getMongoObj: function(params){
       mongoObj = {
        categoriaservicio:[{ type: Schema.Types.ObjectId, ref: 'categoriaservicio' }]
        ,foto:String
        ,orden:Number
   ...
   insert: function(params, _function){
           ...
           connection.open('galeriacategoriaservicio',schema ,function(collection,error) {
   ...
   find: function(id, _function){
           ...
           query.populate('categoriaservicio')
...
.exec(function(err, docs) { 
   ...
   update: function(params,id, _function){
           ...
           if(id===0){
               whereObject = {'categoriaservicio':params[0]};
           }else{
